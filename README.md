...
- [x] Customized UI for easier viewing experience (+1-3pts)
...
1. Adding a searchbar to the application and dealing with type incompatibilities
2. Adding a detailed view upon tapping a movie (expanded details, poster, etc)
...
1. Aligning the collection view cells
2. Making the detail view scrollable so the overview is not cut off

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='Flix_Demo_3.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- [x] Added API functions for science fiction movies similar to Star Wars: The Last Jedi. (+1-3pts)
- [ ] List anything else that you can get done to improve the app functionality! (+1-3pts)

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. How to use the model to add category views
2. Making detail view having a list of similar movies

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='Flix_Demo_4.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

I had trouble refactoring my custom view controllers to conform with the models
